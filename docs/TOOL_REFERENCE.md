...
**777 tools** across 21 categories.
...
| `proj_close` | modal | live_only | Close a project, saving its documents or discarding their edits. |
...
| `sch_mirror_component` | silent | live_only | Mirror a placed schematic component horizontally. |
...
| `pcb_set_via_soldermask_relief` | readonly | live_only | REFUSED on this Altium build: the write crashes the engine. |
